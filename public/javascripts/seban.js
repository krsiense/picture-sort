...
function input_rgb(){
    ...
    //修改 div 的背景颜色
    colorShow.style.background = `rgb(${r}, ${g}, ${b})`
    //改变show div 的文本颜色
    colorShow.style.color = grayscale >= 128 ? 'black' : 'white'; 
    //改变 show div 的显示文本
    colorShow.innerHTML = `rgb(${r}, ${g}, ${b})`;
    // //改变 body 的背景
    // document.body.style.background = `radial-gradient(#ccc, ${rgb(r,g,b)})`
